...
const CarComponent = (
  ...
  return (
    <article className=' hover:scale-105 hover:z-10 duration-300 transition-transform relative utsm:col-span-full sm:col-span-6 lg:col-span-3 h-96'>
        ...
        <button onClick={selectCar} className='w-36 active:bg-white active:text-black h-12 transition-transform absolute bottom-4 right-4 bg-black rounded-lg text-white font-semibold' >
                Select Car
        </button>
    </article>
  )
