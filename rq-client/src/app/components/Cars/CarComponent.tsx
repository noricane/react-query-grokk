...
const CarComponent = (
  ...
  return (
   <article className='sm:col-span-6 lg:col-span-3 h-96'>
        <div className='w-auto h-64'>
            <img className='object-center h-[inherit] object-cover' src={img} alt={`An image of a ${manufacturer} ${model}`} />
            {/* <Image width={720} height={1280} className=' object-fill object-center ' src={img} alt={`An image of a ${manufacturer} ${model}`} /> */}
        </div>
        <section className='w-full h-32 bg-green-200'>
